...
def get_function_spaces_1():
    return (
        ...
        lambda mesh: FunctionSpace(mesh, "Discontinuous Lagrange", 0),
        lambda mesh: FunctionSpace(mesh, "Discontinuous Lagrange", 1),
        pytest_mark_slow(lambda mesh: FunctionSpace(mesh, "Discontinuous Lagrange", 2)),
...
def get_elements_1():
    return (
        ...
        lambda mesh: FiniteElement("Discontinuous Lagrange", mesh.ufl_cell(), 0),
        lambda mesh: FiniteElement("Discontinuous Lagrange", mesh.ufl_cell(), 1),
        pytest_mark_slow(lambda mesh: FiniteElement("Discontinuous Lagrange", mesh.ufl_cell(), 2)),
